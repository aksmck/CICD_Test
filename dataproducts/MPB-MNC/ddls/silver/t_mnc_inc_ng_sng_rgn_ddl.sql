CREATE TABLE IF NOT EXISTS $$unity_catalog_name.$$schema_name.$$delta_table_name (
  ...
  NATL_GRP_CD STRING COMMENT 'Customer National Group Code; SOURCE : YYBRAN1',
  NATL_SUB_GRP_CD STRING COMMENT 'Customer National Sub-Group Code; SOURCE : YYBRAN2',
  CUST_REGION_NUM STRING COMMENT 'Customer Region Number; SOURCE : YYBRAN3',
