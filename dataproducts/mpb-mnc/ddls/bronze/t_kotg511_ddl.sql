CREATE TABLE IF NOT EXISTS $$unity_catalog_name.$$schema_name.$$delta_table_name (
  ...
  YYBRAN1 STRING COMMENT 'Customer National Group Code',
  YYBRAN2 STRING COMMENT 'Customer National Sub-Group Code',
  YYBRAN3 STRING COMMENT 'Customer Region Number',
